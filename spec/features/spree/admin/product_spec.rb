...
RSpec.feature 'Admin Products', :js do
  ...
  context 'for user with admin role' do
    ...
    context 'create products' do
      scenario 'creates new products with vendor id unassigned' do
        visit spree.admin_products_path
        click_link 'New Product'
        expect(current_path).to eq spree.new_admin_product_path

        fill_in 'product_name', with: 'Vendor products'
      ...
      scenario 'creates new products with assigned vendor' do
        visit spree.admin_products_path
        click_link 'New Product'
        expect(current_path).to eq spree.new_admin_product_path
    ...
    context 'edit products' do
      ...
      scenario 'can update an existing products' do
      ...
      scenario 'can update products master price' do
      ...
      scenario 'can update products vendor' do
  ...
  context 'for user with vendor' do
    ...
    context 'index' do
      scenario 'displays only vendor products' do
        expect(page).to have_selector('tr', count: 2)
      end
    end

    context 'create products' do
      scenario 'can create a new products' do
        click_link 'New Product'
        expect(current_path).to eq spree.new_admin_product_path
    ...
    context 'create products property' do
      scenario 'can create new products property' do
        visit spree.admin_product_product_properties_path(vendor_product)
        fill_in 'products[product_properties_attributes][0][property_name]', with: 'Testing edit'
        click_button 'Update'
        expect(page).to have_text 'successfully updated!'
